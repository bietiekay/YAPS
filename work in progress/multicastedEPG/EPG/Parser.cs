...
namespace JMS.DVB.EPG
{
	...
	public class Parser
	{
		...
		/// <summary>
		/// Will be fired whenever <see cref="OnData"/> detects a
		...
		public virtual Section ReadSection()
		{
			...
			for (; ; )
			{
				...
				Section section = Section.Create(m_Buffer, m_BufferPos, m_BufferSize - m_BufferPos);
				...
				// Report
				if (section.IsValid) return section;
			}
		}
